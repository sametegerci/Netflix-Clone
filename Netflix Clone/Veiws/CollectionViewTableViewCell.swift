...
class CollectionViewTableViewCell: UITableViewCell {
    ...
    static let ıdentifier = "CollectionViewTableViewCell"
    ...
    private func downloadTitleAt(indexPath: IndexPath) {
        DataPersistenceMenager.shared.downloadTitleWith(model: titles[indexPath.row]) { result in
            switch result {
            case .success():
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        APICaller.shared.getMovie(with: titleName + "trailer") {[weak self] result in
            ...
            case .success(let videoElement):
                ...
                self?.delegate?.collectionViewTableViewCellDidTapCell(strongeSelf, viewModel: viewModel)
